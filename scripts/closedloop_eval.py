...
def main(args):
    ...
    policy=R_Tf_binary(observation_dim, 2*observation_dim, ca_num, env.smpc.N-1, num_layers, hidden_size, lambda_dim=lambda_dim,lambda_ubd = lambda_ubd,pred_mode=['ca','tertiary','binary'])
